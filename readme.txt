...
2. Search for 'cc-coming-soon'
3. Click 'Install Now'
4. Activate the plugin on the Plugin dashboard
5. Go to Settings > Coming Soon CC to configure the plugin

= Uploading in WordPress Dashboard =

1. Navigate to the 'Add New' in the plugins dashboard
2. Navigate to the 'Upload' area
3. Select `cc-coming-soon.zip` from your computer
4. Click 'Install Now'
5. Activate the plugin in the Plugin dashboard
6. Go to Settings > Coming Soon CC to configure the plugin

= Using FTP =

1. Download `cc-coming-soon.zip`
2. Extract the `cc-coming-soon` directory to your computer
3. Upload the `cc-coming-soon` directory to the `/wp-content/plugins/` directory
4. Activate the plugin in the Plugin dashboard
5. Go to Settings > Coming Soon CC to configure the plugin

== Frequently Asked Questions ==

**1. Why can't I see my Coming Soon page?**
...
If you are logged out and still can't see your coming soon page, try clearing your browser's cache or opening the page in another browser.

**2. How can I enable the additional templates?**
...
1. [Default Coming Soon Page (Free)](https://shop.chop-chop.org/demo/cc-coming-soon-pro/?template=default)
2. [Default Coming Soon Page (Free)](https://shop.chop-chop.org/demo/cc-coming-soon-pro/?template=default)
3. [Chic Coming Soon Page (Pro)](https://shop.chop-chop.org/demo/cc-coming-soon-pro/?template=chic)
4. [Calm Coming Soon Page (Pro)](https://shop.chop-chop.org/demo/cc-coming-soon-pro/?template=calm)
5. [Stylish Coming Soon Page (Pro)](https://shop.chop-chop.org/demo/cc-coming-soon-pro/?template=stylish)
6. [Mobility Coming Soon Page (Pro)](https://shop.chop-chop.org/demo/cc-coming-soon-pro/?template=mobility)
...
= 0.2.5 =
New: LinkedIn icon
Fix: Newsletter button with long text

= 0.2.4 =
Change: admin panel labels
