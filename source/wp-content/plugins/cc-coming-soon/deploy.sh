...
# main config
PLUGINSLUG="cc-coming-soon" # returns basename of current directory
CURRENTDIR=`pwd`
MAINFILE="cc-coming-soon.php" # this should be the name of your main php file in the wordpress plugin
SVNUSER="chopchoporg" # your svn username
